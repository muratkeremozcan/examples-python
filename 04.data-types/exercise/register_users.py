from helper_functions import validate_name, validate_email, validate_password
...
print(register_user('', 'somebody@example.com', 'securePassword123'))  # Expected output: False (invalid name)
# print('\\')
