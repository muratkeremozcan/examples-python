...
for species, sex, body_mass in weight_log:
	if sex == 'FEMALE':
		# if species is already in the dictionary, create an empty list for any missing species
...
for species, sex, body_mass in weight_log:
		if sex == 'MALE':
			# Check if species is already in the dictionary, if not, initialize with an empty list
