...
# JS equivalent:  babyNames.splice(position, 1)  # removes and returns the element at the given index
...
# JS equivalent: babyNames.push(['Kerem', 'Ozcan'])  # adds the array as a single element (nested array)
print(baby_names)
...
# JS equivalent: console.log(babyNames.slice().sort())  // needs .slice to creates a new array