...
# pop(arg, {}) : safe-delete with pop(), the 2nd arg is the default return if nothing is found (otherwise things error) - just like get
squirrels_city_hall = squirrels_by_park.pop('City Hall Park', {})
print(squirrels_city_hall)

# del is like del object['key'] in js; no safe delete (it will throw KeyError if the key doesn't exist)
