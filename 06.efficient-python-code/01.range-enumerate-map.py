...
# - enumerate (and unpacked enumerate via [*enumerate(...)] or tuple unpacking in comprehensions) attaches indices to elements.
...
# in this version each tuple from enumerate(names) is automatically
